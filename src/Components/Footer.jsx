import {
  ...
  export default function Footer() {
    return (
      <Box
        bg={useColorModeValue('rgb(36, 19, 79)', 'rgb(36, 19, 79)')}
        ...
        <Container as={Stack} maxW={'7xl'} py={8} >
          <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8}>
            ...
            <Stack align={'flex-start'}>
              ...
              <Link href={'#'}>About ExpressTech</Link>
      ...
      <SimpleGrid columns={{ base: 1, sm: 1, md: 4 }} spacing={8}>
          ...
          <Stack>
            <Text fontWeight="500">
              EXPERIENCE EXPRESS TECH on MOBILE
            </Text>
        ...
        <Box backgroundColor="rgb(36, 19, 79)" p="2">
        ...
        <Center>
          <Text fontSize="14px" p="1">
            {" "}
            © 2023 ExpressTech. All Rights Reserved.
          </Text>
        </Center>
      </Box>
      </Box>
