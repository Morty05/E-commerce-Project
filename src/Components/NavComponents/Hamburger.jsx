    ...
    const handleLogOut = () => {
      if (!isAuth) {
          toast({
              ...
              render: () => (
                  <Flex color='white'  p={"10px"} bgColor='rgb(36, 19, 79)' borderRadius={"10px"}>
      ...
      <>
        ...
        >
          ...
          <DrawerContent >
            ...
            {
              isAuth ? <DrawerHeader fontSize={"16px"} color="white" fontWeight={"semibold"} bgColor={"rgb(36, 19, 79)"}>Hi, {username}</DrawerHeader> : 
              <DrawerHeader fontSize={"16px"} color="white" fontWeight={"semibold"} bgColor={"rgb(36, 19, 79)"}>Login / Register</DrawerHeader>
            }
